...
13. **Never name a company as a failing example** on a public page. Aggregated and anonymised only. **Carve-out: court proceedings.** Parties to public litigation may be named, because the case is already a matter of public record and the naming comes from the court rather than from us. This covers the French cases (Auchan, Carrefour, E.Leclerc, Picard Surgel&eacute;s) and any comparable proceeding. It does **not** extend to organisations named in a regulator's open investigation that has produced no decision, nor to anything found in our own testing.
